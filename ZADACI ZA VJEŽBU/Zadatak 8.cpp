...
int** hstack(int** m1, int** m2, int r1, int c1, int r2, int c2) {
	if (c1 != c2)
	{
		cout << "Matrice imaju razlicit broj kolona, pa prema tome - vertikalno slaganje se ne moze izvesti.";
		return nullptr;
	}

	int** m3 = createMatrix(r1 + r2, c1);
	int brojRedova = 0;
...
int main() {
	...
	if (m3 != nullptr)
	{
		cout << "Matrica M3 formirana vertikalnim slaganjem matrica M1 i M2: " << endl;
